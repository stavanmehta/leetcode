...
class Solution {
    public int compareVersion(String version1, String version2) {
        ...
        int i = 0;
        int length = Math.max(version1Numbers.length, version2Numbers.length);
        while (i < length) {
            int version1Digit = i < version1Numbers.length ? Integer.parseInt(version1Numbers[i]) : 0;
            int version2Digit = i < version2Numbers.length ? Integer.parseInt(version2Numbers[i]) : 0;
